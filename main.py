...
#     sound_file = "python_practice\\Nebula - The Grey Room _ Density & Time.mp3"
#     is_running = True
...
#         label.setStyleSheet("color: #f61052;"
...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "b1cea632dd6e7985576ea29c2b21278a"
        ...
        try:
            ...
            match response.status_code:
                ...
                case 401:
                    self.display_error("Unquthorized:\nInvalid API keyt")
                case 403:
